Shos.Maze リポジトリの Sources 配下について、可読性を大きく向上させるための英語コメントを追加してください。  
...
- ui-dom.js
- worker-message-protocol.js
- Sources/worker-heap.js
- Sources/worker-messages.js
- app-bootstrap.js
- worker-bootstrap.js
- app-timing.js
...
- 新しい開発者が Sources 配下を読み始めたときに、責務分担を素早く把握できるようにすること
